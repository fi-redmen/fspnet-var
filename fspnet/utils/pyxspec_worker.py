...
print("before import test")
import os

import xspec

#xspec.AllModels.lmod("jscutx", "/Users/astroai/Downloads/simplcutx/")
...
def worker():
    ...
    print("before PyXspecFitting test")
